...
const en = {
  ...
  modelsInstalledCatalog: "Codex builds its picker from your own model catalog, which lists these ChatGPT Web models:",
...
const zh: Record<keyof typeof en, string> = {
  ...
  modelsInstalledCatalog: "Codex 从你自己的模型目录构建选择器，其中包含以下 ChatGPT Web 模型：",
...
const ja: Record<keyof typeof en, string> = {
  ...
  modelsInstalledCatalog: "Codex は独自のモデルカタログからピッカーを構成しており、次の ChatGPT Web モデルが含まれています：",
