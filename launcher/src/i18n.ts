...
const en = {
  ...
  passkeyContinue: "I'm signed in — Continue",
  passkeyImporting: "Importing…",
  passkeyWaitingTitle: "Finish signing in, then choose Continue",
  passkeyContinueBody: "A dedicated Chrome window is open. 1. Sign in to ChatGPT with your passkey. 2. Wait for the message box to appear. 3. Come back here and choose Continue. This window stays in front until you do.",
  ...
  reinstall: "Reinstall",
  checkModels: "Check installed",
  checkingModels: "Checking…",
  modelsInstalledBridge: "Codex has loaded the ChatGPT Web models from this bridge.",
  modelsInstalledCatalog: "Your configured model catalog lists these ChatGPT Web models on disk:",
  modelsRuntimeUnverified: "File contents do not prove that running Codex loaded this catalog or route. Runtime verification is still pending.",
  modelsUnknownSource: "The configured model catalog could not be determined. Check the configuration details below.",
  modelsMissingBridge: "Codex has not requested the model catalog from this bridge yet. Install the models, then restart Codex once.",
  modelsMissingCatalog: "Codex builds its picker from your own model catalog, and that catalog lists no ChatGPT Web models. Add them there, or let this bridge own the picker.",
  modelsRouteMissing: "Your own model catalog owns Codex's picker and lists these ChatGPT Web models, but this bridge has not installed its Codex route yet:",
  modelsPickerSource: "Picker source",
...
const zh: Record<keyof typeof en, string> = {
  ...
  passkeyContinue: "我已登录 — 继续",
  passkeyImporting: "正在导入…",
  passkeyWaitingTitle: "完成登录后选择“继续”",
  passkeyContinueBody: "专用 Chrome 窗口已打开。1. 使用通行密钥登录 ChatGPT。2. 等待消息输入框出现。3. 返回此处并选择“继续”。在此之前本窗口会保持在最前。",
  ...
  checkModels: "检查已安装",
  checkingModels: "检查中…",
  modelsInstalledBridge: "Codex 已从本 Bridge 加载 ChatGPT Web 模型。",
  modelsInstalledCatalog: "磁盘上配置的模型目录包含以下 ChatGPT Web 模型：",
  modelsRuntimeUnverified: "文件内容不能证明运行中的 Codex 已加载此目录或路由。运行时验证仍待完成。",
  modelsUnknownSource: "无法确定配置的模型目录。请检查下方的配置详情。",
  modelsMissingBridge: "Codex 尚未向本 Bridge 请求模型目录。请安装模型，然后重启一次 Codex。",
  modelsMissingCatalog: "Codex 从你自己的模型目录构建选择器，而该目录中没有 ChatGPT Web 模型。请将它们添加到该目录，或让本 Bridge 接管选择器。",
  modelsRouteMissing: "你自己的模型目录掌管 Codex 的选择器，并且其中包含以下 ChatGPT Web 模型，但本 Bridge 尚未安装其 Codex 路由：",
  modelsPickerSource: "选择器来源",
...
const ja: Record<keyof typeof en, string> = {
  ...
  passkeyContinue: "サインイン済み — 続行",
  passkeyImporting: "インポート中…",
  passkeyWaitingTitle: "サインインを完了して「続行」を選択",
  passkeyContinueBody: "専用の Chrome ウィンドウが開いています。1. パスキーで ChatGPT にサインインします。2. メッセージ入力欄が表示されるまで待ちます。3. ここに戻って「続行」を選択します。それまでこのウィンドウは最前面に表示されます。",
  ...
  install: "モデルをインストール",
  reinstall: "再インストール",
  checkModels: "インストール状況を確認",
  checkingModels: "確認中…",
  modelsInstalledBridge: "Codex はこのブリッジから ChatGPT Web モデルを読み込み済みです。",
  modelsInstalledCatalog: "設定されたディスク上のモデルカタログには、次の ChatGPT Web モデルが含まれています：",
  modelsRuntimeUnverified: "ファイルの内容だけでは、実行中の Codex がこのカタログやルートを読み込んだとは確認できません。実行時の検証は未完了です。",
  modelsUnknownSource: "設定されたモデルカタログを確認できません。以下の設定の詳細を確認してください。",
  modelsMissingBridge: "Codex はまだこのブリッジにモデルカタログを要求していません。モデルをインストールし、Codex を一度再起動してください。",
  modelsMissingCatalog: "Codex は独自のモデルカタログからピッカーを構成していますが、そのカタログに ChatGPT Web モデルがありません。カタログに追加するか、このブリッジにピッカーを任せてください。",
  modelsRouteMissing: "独自のモデルカタログが Codex のピッカーを管理しており、次の ChatGPT Web モデルが含まれていますが、このブリッジは Codex ルートをまだインストールしていません：",
  modelsPickerSource: "ピッカーの取得元",
